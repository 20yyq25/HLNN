...
class HLNN_Model:
    ...
    def __init__(args):
        ...
        # 2.2 初始化编码器 
        self.encoder = HLNN_Encoder(c, args)
...
# ============================================================================
# 3. HLNN编码器 (models/encoders.py -> HLNN类)
# ============================================================================
...
class HLNN:
    ...
    def __init__(manifold, in_features, out_features, c, c_in, c_out, k, dropout, dprate, act, bias):
        ...
        # 4.3 传播层 (核心组件)
        self.prop = Legendre_prop(K=k, c=c, manifold=manifold, adaptive=True)
